...
def uri2options(uri):
    ...
    calling this function with uri="coap://[aaaa::1]:1234/test1/test2?arg1&arg2"
    returns 
    (
        'aaaa::1',
        1234,
    ...
    Calling this function with uri="http://[aaaa::1]/test1/test2?arg1&arg2"
