...
URIANDOPTIONS = [
    ...
    (
        'coap://[aaaa::1]/test?arg',
        (
            'aaaa::1',
            d.DEFAULT_UDP_PORT,
            (
                coapOption.UriPath(path='test'),
                coapOption.UriQuery(argument='arg'),
            ),
        )
    ),
    (
    ...
    (
        'coap://[bbbb::1415:92cc:0:2]/t?a',
        (
            'bbbb::1415:92cc:0:2',
            5683,
            (
                coapOption.UriPath(path='t'),
                coapOption.UriQuery(argument='a'),
            ),
        )
    ),
    (
    ...
    (
        'coap://[aaaa::1]:1234/test1/test2?arg1&arg2',
        (
            'aaaa::1',
            1234,
            (
                coapOption.UriPath(path='test1'),
                coapOption.UriPath(path='test2'),
                coapOption.UriQuery(argument='arg1'),
                coapOption.UriQuery(argument='arg2'),
            ),
        )
    ),
    (
    ...
    (
        'coap://vs0.inf.ethz.ch:5683/test1/test2?arg1&arg2',
        (
            'vs0.inf.ethz.ch',
            5683,
            (
    ...
    (
        'coap://[bbbb::1415:92cc:0:3]/res/ource?arg&ument',
        (
            'bbbb::1415:92cc:0:3',
            5683,
            (
                ...
                coapOption.UriPath(path='ource'),
                coapOption.UriQuery(argument='arg'),
                coapOption.UriQuery(argument='ument'),
            ),
        )
    ),
    (
    ...
    (
        'coap://[bbbb::1415:92cc:0000:0003]/res/ource?arg&ument',
        (
            'bbbb::1415:92cc:0:3',
            5683,
            (
